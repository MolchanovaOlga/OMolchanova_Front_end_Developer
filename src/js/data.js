const teamProject = [
  {
    ...
    imageMobBig: 'focus-frame-mob-2x',
    imageMobSmall: 'focus-frame-mob-1x',
    imageTablDeskBig: 'focus-frame-tabl-desk-2x',
    imageTablDeskSmall: 'focus-frame-tabl-desk-1x',
  },
  {
    name: 'Energy Flow',
    technologies: 'HTML, CSS, JS, Vite',
    ...
    imageMobBig: 'energy-flow-mob-2x.jpg',
    imageMobSmall: 'energy-flow-mob-1x.jpg',
    imageTablDeskBig: 'energy-flow-tabl-desk-2x.jpg',
    imageTablDeskSmall: 'energy-flow-tabl-desk-1x.jpg',
  },
];
...
const individualProject = [
  {
    ...
    imageMobBig: 'web-studio-mob-2x.jpg',
    imageMobSmall: 'web-studio-mob-1x.jpg',
    imageTablDeskBig: 'web-studio-tabl-desk-2x.jpg',
    imageTablDeskSmall: 'web-studio-tabl-desk-1x.jpg',
  },
  {
    name: 'Timer',
    technologies: 'HTML, CSS, JS, Vite',
    ...
    imageMobBig: 'timer-mob-2x.jpg',
    imageMobSmall: 'timer-mob-1x.jpg',
    imageTablDeskBig: 'timer-tabl-desk-2x.jpg',
    imageTablDeskSmall: 'timer-tabl-desk-1x.jpg',
  },
  {
    name: 'Gallery',
    technologies: 'HTML, CSS, JS, Vite',
    ...
    imageMobBig: 'gallery-mob-2x.jpg',
    imageMobSmall: 'gallery-mob-1x.jpg',
    imageTablDeskBig: 'gallery-tabl-desk-2x.jpg',
    imageTablDeskSmall: 'gallery-tabl-desk-1x.jpg',
  },
];
